...
The ACS loader streams official Summary File tables for Cumberland County county subdivisions and caches the selected town records in `data/raw/acs_town_demographics.json`. Current indicators include total population, median household income, poverty, zero-vehicle households, population age 65 and older, and disability.
